    ...
    return (
        <section id="community-section" className="px-8 mb-8 w-full">
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                ...
                {/* Community Feed */}
                <div className="xl:col-span-8 bg-gravl-card rounded-2xl border border-gravl-border p-6">
                    ...
                    <div className="space-y-6">
                        {posts.map((post, index) => (
                            <div key={index} className="flex space-x-4 border-b border-gravl-border last:border-0 pb-6 last:pb-0">
                                <div className="flex-shrink-0">
                                    <div className="w-10 h-10 rounded-full overflow-hidden border border-gravl-border">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-gray-300 text-sm mt-2 mb-3">{post.content}</p>

                                    <div className="flex space-x-6">
                                        <button className="flex items-center space-x-1 text-gray-400 hover:text-red-500 transition text-xs font-medium">
                                            <Heart className="w-4 h-4" /> <span>{post.likes}</span>
                                        </button>
                                        <button className="flex items-center space-x-1 text-gray-400 hover:text-blue-500 transition text-xs font-medium">
                                            <MessageSquare className="w-4 h-4" /> <span>{post.comments}</span>
                                        </button>
                                        <button className="flex items-center space-x-1 text-gray-400 hover:text-white transition text-xs font-medium">
                ...
                {/* Training Insights */}
                <div className="xl:col-span-4 bg-gravl-card rounded-2xl border border-gravl-border p-6 bg-gradient-to-br from-gravl-card to-gravl-bg">
                    ...
                    <div className="space-y-4">
                        <div className="p-4 bg-gravl-bg/50 rounded-xl border border-white/5">
