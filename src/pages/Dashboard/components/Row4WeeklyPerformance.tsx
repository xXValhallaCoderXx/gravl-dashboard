            ...
            <div className="bg-card-bg rounded-2xl border border-slate-custom p-6">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p className="text-slate-custom text-sm">Your training volume over the past 7 days</p>
                    </div>
                    <div className="flex space-x-2">
                        <Button className="bg-volt text-deep-focus font-semibold text-sm hover:bg-volt/90 h-8 px-4 rounded-lg">Week</Button>
                        <Button variant="outline" className="bg-deep-navy text-slate-custom border-slate-custom hover:border-white h-8 px-4 rounded-lg">Month</Button>
                        <Button variant="outline" className="bg-deep-navy text-slate-custom border-slate-custom hover:border-white h-8 px-4 rounded-lg">Year</Button>
                    </div>
                </div>
